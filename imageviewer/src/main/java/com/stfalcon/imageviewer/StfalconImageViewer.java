...
public class StfalconImageViewer<T> {
   ...
   * Displays the built viewer if passed list of images is not empty
   *
   * @param animate whether the passed transition view should be animated on open. Useful for screen
   * rotation handling.
   */
  ...
  /**
   * Updates transition image view. Useful for a case when image position has changed and you want
   * to update the transition animation target.
   */
  ...
  public static class Builder<T> {
    ...
    /**
     * Sets custom overlay view to be shown over the viewer. Commonly used for image description or
     * counter displaying.
     *
     * @return This Builder object to allow calls chaining
     */
    ...
    /**
     * Sets `start`, `top`, `end` and `bottom` padding for zooming and scrolling area using
     * dimension.
     *
     * @return This Builder object to allow calls chaining
     */
    ...
    /**
     * Creates a {@link StfalconImageViewer} with the arguments supplied to this builder. It does
     * not show the dialog. This allows the user to do any extra processing before displaying the
     * dialog. Use {@link #show()} if you don't have any other processing to do and want this to be
    ...
    /**
     * Creates the {@link StfalconImageViewer} with the arguments supplied to this builder and shows
     * the dialog.
     */
     ...
     * the dialog.
     *
     * @param animate whether the passed transition view should be animated on open. Useful for
